...
export const DineIn = (props: any) => {
  return (
    <Svg width={30} height={32} fill="none" {...props}>
      <Path
        d="M22 0a8 8 0 018 8v16a8 8 0 01-8 8H8a8 8 0 01-8-8V8a8 8 0 018-8h14z"
        fill="#DBEAFE"
      />
      <Path
        d="M22 0a8 8 0 018 8v16a8 8 0 01-8 8H8a8 8 0 01-8-8V8a8 8 0 018-8h14z"
      ...
      <G clipPath="url(#prefix__clip0_160_2246)">
        <Path
      ...
      <Defs>
        <ClipPath id="prefix__clip0_160_2246">
